...
Selkies setup script for Debian Trixie amd64 running inside LXD container.

Based on [Selkies Base Images from LinuxServer](https://github.com/linuxserver/docker-baseimage-selkies/tree/ubuntunoble).

## Setting up
```
git clone --single-branch --branch debiantrixie-amd64 https://github.com/TranceEX/selkies-lxd.git
cd selkies-lxd
bash setup.kde.sh
```
